...
public class DB {
    ...
    public func result() -> [DBResultImage]  {
        
        var statement: OpaquePointer?
        
        var results: [DBResultImage] = []
        ...
        while sqlite3_step(statement) == SQLITE_ROW {
            ...
            results.append(DBResultImage(t1key: t1key, data: data, num: num,image: image, timeEnter: timeEnter))
    ...
    public func resultNI(sql: String) -> [DBResultNoImage]  {
        
        var statement: OpaquePointer?
        
        var results: [DBResultNoImage] = []
        ...
        while sqlite3_step(statement) == SQLITE_ROW {
            ...
            results.append(DBResultNoImage(t1key: t1key, data: data, num: num,timeEnter: timeEnter))
